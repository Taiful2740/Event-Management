      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
        ...
        <div>
          <div class="relative flex w-full max-w-[17rem] flex-col rounded-xl bg-gradient-to-tr from-[#b378d4] to-[#b153e8] bg-clip-border p-8 text-white shadow-md shadow-[#b153e8]">
            ...
            <div class="mt-12 p-0">
              <button
                class="block w-full select-none rounded-lg bg-white py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-[#b153e8] shadow-md shadow-blue-gray-500/10 transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-gray-500/20 focus:scale-[1.02] focus:opacity-[0.85] focus:shadow-none active:scale-100 active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                type="button"
